...
<form class="form" action="cadastrargerente.php" method="post">
    ...
    <div class="form_grupo">
        ...
        <input type="text"  pattern="\d{3}\.\d{3}\.\d{3}-\d{2}"  name="cpf" class="form_input" id="cpf" placeholder="CPF" required>
    </div>
    <div class="form_grupo">
        <label for="Cargo" class="form_label">Cargo</label>
        <input type="text" name="cargo" class="form_input" id="cargo" placeholder="Cargo" required>
    </div>
